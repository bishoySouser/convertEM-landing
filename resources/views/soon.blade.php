...
@section('content')
    <main class="min-h-screen py-16 flex items-center justify-center relative overflow-hidden" style="
        ...
        <div class="convertem-section text-center px-6 max-w-3xl mx-auto">
            ...
            <div class="convertem-logo mb-6">
                <img src="{{asset('site_assets/images/convertem.svg')}}" alt="ConvertEm"
            ...
            <!-- Title -->
            <h1 class="convertem-title text-white font-extrabold leading-tight
            ...
            <!-- Email Form -->
            <form action="{{ route('landing.notify') }}" method="post"
                ...
                <button type="submit" class="h-10 sm:h-12 px-8 rounded-xl text-white font-semibold
